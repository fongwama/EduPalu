...
$(document).ready(function(){
  ...
  var db_geo;
    ...
    function searchPharma(query_field){
        ...
        if(content !="")
          $("#results_csi").html(content);

    }
    
    // When search by pharmacy name
    $("#btn_search_csi").click(function() {
            // clean input field
        var query_field = $("#input_name_csi").val().trim().toLowerCase().latinise(); 
        searchPharma(query_field);
    });

    // Search at every key press
    $("#input_name_csi").keyup( function() {
	...
	$("#btn_search_near_csi").click(function() {
        
        $("#results_csi").html("Veuillez autoriser la géolocalisation et patientez quelques instants...");
    ...
    function getNearestPlaces(position)
    {
        ...
        $("#results_csi").html("Position trouvée !");
